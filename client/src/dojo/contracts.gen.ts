...
export function setupWorld(provider: DojoProvider) {
	...
	const build_dice_system_rollDice_calldata = (gameId: BigNumberish, playerIndex: BigNumberish, value: BigNumberish): DojoCall => {
		return {
	...
	const dice_system_rollDice = async (snAccount: Account | AccountInterface, gameId: BigNumberish, playerIndex: BigNumberish, value: BigNumberish) => {
		try {
	...
	const build_gamesystem_createGame_calldata = (gameId: BigNumberish, maxPlayers: BigNumberish): DojoCall => {
		return {
	...
	const gamesystem_createGame = async (snAccount: Account | AccountInterface, gameId: BigNumberish, maxPlayers: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const build_gamesystem_joinGame_calldata = (gameId: BigNumberish): DojoCall => {
		return {
			contractName: "gamesystem",
	...
	const gamesystem_joinGame = async (snAccount: Account | AccountInterface, gameId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const build_gamesystem_startGame_calldata = (gameId: BigNumberish): DojoCall => {
		return {
			contractName: "gamesystem",
	...
	const gamesystem_startGame = async (snAccount: Account | AccountInterface, gameId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const build_piece_system_movePiece_calldata = (gameId: BigNumberish, playerIndex: BigNumberish, pieceIndex: BigNumberish): DojoCall => {
		return {
	...
	const piece_system_movePiece = async (snAccount: Account | AccountInterface, gameId: BigNumberish, playerIndex: BigNumberish, pieceIndex: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
