...
mod piece_system {
    ...
    impl IPieceSystemImpl of IPieceSystem<ContractState> {
        // fn move_piece(ref self: ContractState, game_id: felt252, player_index: u8, piece_index:
        // u8){
        ...
        //         let is_kill = self.check_for_kill(game_id, player_index, piece_index,
        //         piece.position);
    ...
    impl InternalImpl of InternalTrait {
        ...
        fn check_for_kill(
            ...
            let opponent_index: u8 = if current_player == 0 {
                1_u8
            } else {
                0_u8
            };
